...
const Navbar = ({ searchText, setSearchText }) => {
    return (
        <div className='flex justify-center sm:justify-between w-full bg-[#FFCC00] text-[#2C3E50] h-20 items-center px-3'>
            <img src={pokemonLogo} className='w-[10rem] max-h-16 h-fit hidden sm:block' alt='pokemon logo' />
            ...
            <div className='sm:hidden flex gap-2 items-center justify-center'>
                ...
                <img src={pokemonLogo} className='w-[10rem] max-h-16 h-fit block sm:hidden' alt='pokemon logo' />
            </div>
